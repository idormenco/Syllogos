          ...
          {availableParentQuestions.length === 0 && (
            <TooltipProvider>
              <Tooltip delayDuration={300}>
                ...
                <TooltipContent>
                  <p className='text-slate-700 text-sm w-[250px]'>You need to have a prior question of type number question/rating question/single select / multiple select to enable display logic</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          )}
